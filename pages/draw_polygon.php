  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: "../script_tncweb/read_point_verified_and_no.php",
                type: "POST",
                data: {
                },
                dataType: "JSON",
...
google.maps.event.addListener(circle, 'center_changed', function (event) {
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmHJRiCR5sZ2jTMxkTIqZDQa6GV4hMzYg&libraries=drawing&callback=initMap"
         async defer></script>
